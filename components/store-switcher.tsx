    ...
    return (
        <Popover open={onOpen} onOpenChange={setOpen}>
            <PopoverTrigger asChild>
                <Button variant='outline' size='sm' role='combobox' aria-expanded={onOpen} aria-label="Select a store" className={cn("w-[200px] justify-between", className)}>
